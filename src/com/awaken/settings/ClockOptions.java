...
public class ClockOptions extends SettingsPreferenceFragment
	...
	// clock settings
        mStatusBarClockShow = (SystemSettingSwitchPreference) findPreference(STATUSBAR_CLOCK);
        mStatusBarSecondsShow = (SystemSettingSwitchPreference) findPreference(STATUSBAR_CLOCK_SECONDS);
        ...
        if (DateFormat.is24HourFormat(getActivity())) {
            ...
            mStatusBarAmPm.setSummary(R.string.statusbar_am_pm_info);
        } else {
